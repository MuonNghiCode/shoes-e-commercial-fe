  ...
  return (
    <div className="max-w-[1200px] mx-auto mt-10 p-0">
      ...
      <div className="flex items-center gap-6 mb-8">
        <div className="w-8 h-8 rounded-full bg-black text-white flex items-center justify-center font-bold text-lg">1</div>
        <span className="font-bold text-2xl md:text-3xl">Giỏ hàng</span>
        <span className="text-gray-300 text-2xl">→</span>
        <div className="w-8 h-8 rounded-full bg-gray-200 text-gray-400 flex items-center justify-center font-bold text-lg">2</div>
        <span className="text-gray-400 font-bold text-2xl md:text-3xl">Chi tiết thanh toán</span>
        <span className="text-gray-300 text-2xl">→</span>
        <div className="w-8 h-8 rounded-full bg-gray-200 text-gray-400 flex items-center justify-center font-bold text-lg">3</div>
        ...
        <div className="flex-1 bg-white rounded-2xl shadow-lg p-8 mb-10">
          {cart.length === 0 ? (
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  <th className="p-3 font-bold text-[#bfa046] text-left">Sản phẩm</th>
          ...
          <div className="mb-3">
            ...
            <div>
              <label className="block mb-1">
                <input type="radio" name="shipping" value="free" checked={shipping === "free"} onChange={() => setShipping("free")} className="mr-2" />
                Miễn phí vận chuyển
              </label>
              <label className="block mb-1">
                <input type="radio" name="shipping" value="flat" checked={shipping === "flat"} onChange={() => setShipping("flat")} className="mr-2" />
                Giao hàng tiêu chuẩn: 10.000đ
              </label>
              <label className="block">
                <input type="radio" name="shipping" value="pickup" checked={shipping === "pickup"} onChange={() => setShipping("pickup")} className="mr-2" />
                Nhận tại cửa hàng: 15.000đ
              </label>
            </div>
            <div className="text-gray-400 text-xs mt-2">
              Giao đến 211, 121, hcm, 1111, Afghanistan.<br />
              <a href="#" className="text-[#bfa046] underline">Đổi địa chỉ</a>
            </div>
          </div>
